...
const Veg_Logo = (
  ...
  >
    <rect
      ...
      strokeWidth="2"
    />
    <circle cx="50" cy="50" r="25" fill="#128540" />
  </svg>
);
...
const Non_veg = (
  ...
  >
    <rect
      ...
      strokeWidth="2"
    />
    <circle cx="50" cy="50" r="25" fill="#e43b4f" />
  </svg>
);
